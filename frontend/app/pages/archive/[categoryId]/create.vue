...
// Fetch nomenklaturas for display + the "change nomenklatura" selector.
...
<template>
  <PagePanel title="Yangi hujjat" icon="i-lucide-file-plus">
    ...
    <div class="p-6">
      <!-- Nomenklatura selector (switch which nomenklatura this document goes into) -->
      <div v-if="categories.length > 1" class="mb-6 flex items-center gap-3">
        ...
        <div class="flex flex-wrap gap-2">
          <UButton
            ...
            size="sm"
            @click="navigateTo(`/archive/${cat.id}/create`, { replace: true })"
          />
        </div>
      </div>
